...
if test_solution_1 == testdata_1_result and test_solution_1 is not None:
    ...
    print(f"Own solution should be {sol_1} ({'%.3f' % (end_part_1 - start_part_1)}s)")  # 319062
else:
...
if test_solution_2 == testdata_2_result and test_solution_2 is not None:
    ...
    print(f"Own solution should be {sol_2} ({'%.3f' % (end_part_2 - start_part_2)}s)")  # 118638369682135
else:
